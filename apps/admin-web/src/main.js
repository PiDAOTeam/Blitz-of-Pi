...
`)}</textarea></label>
          ...
          <label><span>\u97F3\u6548\u97F3\u91CF</span><input name="effectSoundVolume" type="number" inputmode="decimal" min="0" max="1" step="0.05" value="${n.visualEffects?.soundVolume ?? 0.85}" /></label>
          <label>
            <span>\u5BF9\u6218\u80CC\u666F\u97F3\u4E50</span>
          ...
          <label><span>\u80CC\u666F\u97F3\u4E50\u97F3\u91CF</span><input name="effectBgmVolume" type="number" inputmode="decimal" min="0" max="0.5" step="0.01" value="${n.visualEffects?.bgmVolume ?? 0.12}" /></label>
          <label>
            <span>\u88AB\u653B\u51FB\u6587\u5B57\u63D0\u793A</span>
