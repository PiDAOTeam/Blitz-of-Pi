...
`)}</textarea></label>
          ...
          <div class="avatar-config">
            ...
            <div class="rank-row">
              <label><span>\u68CB\u76D8\u53CD\u9988</span><input name="effectBoardEffectSeconds" type="number" inputmode="decimal" min="0.05" max="3" step="0.01" value="${n.visualEffects?.animationDurations?.boardEffectSeconds ?? 0.24}" /></label>
              ...
              <label><span>\u65B9\u5757\u7206\u5F00</span><input name="effectTileBurstSeconds" type="number" inputmode="decimal" min="0.05" max="3" step="0.01" value="${n.visualEffects?.animationDurations?.tileBurstSeconds ?? 0.28}" /></label>
            ...
            <div class="rank-row">
              <label><span>\u65B9\u5757\u4E0B\u843D</span><input name="effectTileFallSeconds" type="number" inputmode="decimal" min="0.05" max="3" step="0.01" value="${n.visualEffects?.animationDurations?.tileFallSeconds ?? 0.22}" /></label>
            ...
            <div class="rank-row">
              <label><span>\u6ED1\u52A8\u53CD\u9988</span><input name="effectLocalSwapSeconds" type="number" inputmode="decimal" min="0.05" max="3" step="0.01" value="${n.visualEffects?.animationDurations?.localSwapSeconds ?? 0.15}" /></label>
