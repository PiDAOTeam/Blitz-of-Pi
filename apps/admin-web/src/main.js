...
`)}</textarea></label>
          ...
          <div class="checkbox-grid">
            <label><input type="checkbox" name="extremeRealtimeMode" value="quick_battle" ${(Array.isArray(n.extremeRealtime?.enabledModes) ? n.extremeRealtime.enabledModes : ["quick_battle", "points_battle", "poc_battle", "pi_battle"]).includes("quick_battle") ? "checked" : ""} /> \u5FEB\u901F\u5F00\u6218</label>
            <label><input type="checkbox" name="extremeRealtimeMode" value="points_battle" ${(Array.isArray(n.extremeRealtime?.enabledModes) ? n.extremeRealtime.enabledModes : ["quick_battle", "points_battle", "poc_battle", "pi_battle"]).includes("points_battle") ? "checked" : ""} /> \u5C0F\u5BCC\u8C6A\uFF08\u79EF\u5206\uFF09</label>
