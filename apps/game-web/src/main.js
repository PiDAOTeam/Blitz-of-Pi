    ...
    <div class="mode-sheet-mask" id="watch-shareholder-sheet-mask">
      <section class="mode-sheet daily-reward-sheet watch-shareholder-sheet">
        ...
        <div class="watch-shareholder-summary">
          ...
          <article class="watch-shareholder-claim-card"><span>${i(n("watchShareholderCanClaim"))}</span><strong>${i(`${t}`)}</strong>${u ? `<button type="button" id="claim-watch-shareholder">${i(n("watchShareholderClaimAll"))}</button>` : `<small>${i(r > 0 ? n("watchShareholderNoClaim") : n("watchShareholderNotNode"))}</small>`}</article>
